...
(function () {
    ...
    {
        $routeProvider.when("/home", {templateUrl: "http://localhost/tasks/Home/main"})
                .when("/signin", {
                    resolve:
                            {
                    ...
                    templateUrl: "http://localhost/tasks/Home/signin"})
                .when("/signup", {
                    resolve:
                            {
                                "check": function ($location, $rootScope) {
                    ...
                    templateUrl: "http://localhost/tasks/Home/signup"})
                .when("/profile", {
                    resolve:
                            {
                                "check": function ($location, $rootScope) {
                ...
                .otherwise({templateUrl: "http://localhost/tasks/Home/main"});
