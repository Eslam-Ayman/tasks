        ...
        <div class="row" style="margin-top: 27px;">
            <div class="col-sm-12">
                <fieldset>
                    ...
                    <div class="container-fluid">
                    <div class="row">
                        <form class="col-xs-12 col-sm-8">
                        <div class="container-fluid">
                            <div class="form-group row">
                                <label for="exampleInputEmail1">User Name</label><div class="clearfix"></div>
                                <input disabled type="text" class="form-control col-xs-12 col-sm-8" placeholder="username" value="<?php echo $_SESSION['username'];?>">
                            ...
                            <div class="form-group row">
                                ...
                                <input disabled type="email" class="form-control" placeholder="Email" value="<?php if(isset($_SESSION['username']))echo $_SESSION['email'];?>">
                            ...
                            <div class="form-group row">
                                ...
                                <input disabled type="password" class="form-control" placeholder="Password" value="123456">
                            ...
                            <div class="form-group row">
                                ...
                                <input disabled type="text" class="form-control" placeholder="birth-date" value="1996-12-1">
                            ...
                            <div class="form-group row">
                                ...
                                <input disabled type="text" class="form-control" placeholder="Phone Number" value="02 + <?php echo $_SESSION['phone'];?>">
                            ...
                            <div class="form-group row">
                                ...
                                <input disabled type="text" class="form-control" placeholder="Country" value="Giza - Egypt">
                            ...
                            <div style="padding:30px 0px 10px 50px ; line-height:44px">
                                <button type="button" class="btn btn-srch btn-profile"  style="margin-right:50px"><i class="fa fa-bookmark-o" aria-hidden="true"></i>Save Profile</button>
                                <button type="button" class="btn btn-danger"><i class="fa fa-ban" aria-hidden="true"></i>Delete Account</button>
                            </div>
                         </div>
                         </form>
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="username..."></div>
                  </div>
             </form>
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="new email..."></div>
                  </div>
             </form>
	      </div><!-- end of model-body -->
	      <div class="modal-footer">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content" id="myModal">
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    <label for="exampleInputName2" class="control-label col-sm-3">New Password</label>
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="Password..."></div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName2" class="control-label col-sm-3">confirm Password</label>
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="retype Password..."></div>
                  </div>
             </form>
	      </div><!-- end of model-body -->
	      <div class="modal-footer">
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="birthdate..."></div>
                  </div>
             </form>
	      </div><!-- end of model-body -->
	      <div class="modal-footer">
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="phone number..."></div>
                  </div>
             </form>
	      </div><!-- end of model-body -->
	      <div class="modal-footer">
	      ...
	      <div class="modal-body">
	          <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" class="form-control" id="exampleInputName2" placeholder="government / Country..."></div>
                  </div>
             </form>
	      </div><!-- end of model-body -->
	      <div class="modal-footer">
